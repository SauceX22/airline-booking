  ...
  seat: ({ ...props }: LucideProps) => (
    <svg
      ...
      <g transform="translate(0,512) scale(0.100000,-0.100000)">
        <path
          d="M1070 5106 c-213 -58 -359 -276 -321 -480 11 -59 596 -2251 677
-2534 l15 -54 28 39 c41 57 125 129 185 158 99 48 144 55 384 55 151 0 222 3
222 11 0 6 -49 195 -110 420 -60 226 -110 412 -110 415 0 2 356 4 791 4 l791
0 -4 118 c-3 109 -5 122 -30 159 -14 22 -43 48 -65 59 -36 18 -74 19 -810 22
-721 2 -772 4 -777 20 -3 9 -82 305 -176 657 -98 366 -184 667 -200 703 -82
177 -302 280 -490 228z"
        />
        <path
          d="M1727 4753 c-17 -3 -27 -9 -24 -16 2 -7 55 -201 117 -432 61 -231
115 -423 118 -427 10 -11 84 25 125 61 68 60 68 59 -29 422 -95 357 -100 368
-179 388 -44 11 -74 12 -128 4z"
        />
        <path
          d="M1786 2189 c-113 -27 -234 -129 -288 -245 -58 -124 -48 -286 26 -402
31 -49 102 -118 151 -147 99 -58 50 -56 1266 -53 l1114 3 65 31 c175 83 279
270 251 450 -26 170 -140 305 -300 354 -61 19 -94 20 -1155 19 -617 -1 -1108
-5 -1130 -10z"
        />
        <path
          d="M2120 1247 c0 -2 -47 -201 -105 -443 -121 -506 -124 -533 -74 -633
21 -43 47 -75 81 -102 91 -72 64 -70 914 -67 l759 3 52 24 c59 26 121 88 154
153 45 88 40 126 -79 618 l-107 445 -798 3 c-438 1 -797 1 -797 -1z"
        />
      </g>
    </svg>
  ),
  flightDate: ({ ...props }: LucideProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="512"
      height="512"
      ...
      strokeLinejoin="round"
      {...props}>
      <path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3" />
      <path d="M16 2v4" />
      <path d="M8 2v4" />
      <path d="M3 10h4" />
      <path
        d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"
        transform="translate(7.3, 6) rotate(8) scale(0.72)"
      />
    </svg>
  ),
  calendarPay: ({ ...props }: LucideProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="512"
      height="512"
      ...
      />
      <path d="M12 18V6" transform="translate(10, 10) scale(0.5)" />
